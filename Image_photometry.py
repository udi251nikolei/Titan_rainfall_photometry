...
for n in range(image_files_length):
    ...
    try:
        aperture, annulus_aperture = functs.get_titan_aperture(image_files[n], camera_filter, camera, satellite_distance, pixel_angular_size)
    except:
        ...
        image_number, titan_aperture_sky_reduced, titan_intensity = functs.image_photometry(image_files[n], image_numbers[n], satellite_distance, exposure_time[n], aperture, annulus_aperture)
